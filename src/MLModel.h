...
// Subclasses override doPropertyChangeAction to propagate any changes from
// Properties to the core logic.
...
public:
  ...
  // this listening will happen on the message thread. A Model doing DSP in a
  // realtime thread must not turn this on! instead call updateChangedProperties
  // where appropriate.
