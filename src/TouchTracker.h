...
public:
  ...
  // process input and get touches. returns one frame of touch data. changes
...
private:
  ...
  TouchArray filterTouchesZ(const TouchArray &x, const TouchArray &x1,
                            float upFreq, float downFreq);
