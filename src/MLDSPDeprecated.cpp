...
//	0			011 1111 1		000 0000 0000 0000 0000
//0000
...
void MLRandReset(void) { gMLRandomSeed = 0; }
...
void MLBiquad::setCoefficients(float pa0, float pa1, float pa2, float pb1,
                               float pb2) {
  a0 = pa0;
  a1 = pa1;
  a2 = pa2;
...
void MLFDN::setIdentityMatrix() { mMatrix.setIdentity(); }
...
MLHalfBandFilter::AllpassSection::AllpassSection() : a(0) { clear(); }

MLHalfBandFilter::AllpassSection::~AllpassSection() {}

void MLHalfBandFilter::AllpassSection::clear() { x0 = x1 = y0 = y1 = 0.f; }
...
void MLDownsample2x::clear() { f.clear(); }

// ----------------------------------------------------------------
#pragma mark MLUpsample2x

void MLUpsample2x::clear() { f.clear(); }
